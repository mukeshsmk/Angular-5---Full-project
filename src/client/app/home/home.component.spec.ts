  ...
  describe('Home component', () => {
    ...
    it('should work', async(() => {
      TestBed.compileComponents().then(() => {
        ...
        const mockNameListService = fixture.debugElement.injector.get<any>(
          NameListService
        ) as MockNameListService;
        const nameListServiceSpy = spyOn(
          mockNameListService,
          'get'
        ).and.callThrough();
        ...
        expect(homeInstance.nameListService).toEqual(
          jasmine.any(MockNameListService)
        );
        ...
        expect(homeDOMEl.querySelectorAll('li')[3].textContent).toEqual(
          'Minko'
        );
      });
    }));
